...
class MakeMigrationCommand extends Command
{
     ...
     * @var string
     */
    protected $description = 'Make migration custom';
    ...
    */
    public function getStubVariables()
    {
        ...
        $table = Str::ucfirst($table);
        $tableName  = Str::lower(Str::pluralStudly(class_basename($this->argument('name'))));
        return [
            '{{ table }}'  => $tableName,
    ...
    public function getSourceFilePath()
    {
        ...
        return base_path('database\\migrations') .'\\'.date('Y').'_'.date('m').'_'.date('d').'_000000_create_'.$tableName . '_table.php';
    }
